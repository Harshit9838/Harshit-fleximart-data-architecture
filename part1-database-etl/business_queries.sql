...
/* =========================================================
   ...
   Business Question:
   For each product category, show the category name, number
   of different products sold, total quantity sold, and total
   revenue generated. Include only categories that have
...
/* =========================================================
   ...
   and the running total of revenue from January onward.
   ========================================================= */
